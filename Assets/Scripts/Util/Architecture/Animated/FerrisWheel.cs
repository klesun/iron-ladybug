...
namespace Util.Architecture.Animated
{
    public class FerrisWheel : MonoBehaviour
    {
        ...
        {
            return (initialOffset + (Assets.Scripts.Util.Bgm.Bgm.Inst().GetProgress() - startTime) * periodDenominator / periodNumerator) % 1;
        }
        ...
        public void SetFrequence(float value)
        {
            ...
            startTime = Assets.Scripts.Util.Bgm.Bgm.Inst().GetProgress();
